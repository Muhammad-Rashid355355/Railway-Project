...
<div class="container">
	<div class="screen">
		<div class="screen__content">
			<form class="login" method='post' action='../forms/scheduletrip.php'>
				<div class="login__field">
					<i class="login__icon fas fa-user"></i>
                    <select name='ttype' required class="login__input">
                ...
                <div class="login__field">
					<i class="login__icon fas fa-user"></i>
                <select name='train' class="login__input" id="STrain" required>
                    ...
                    <select name='route'  class="login__input" id="STrain" required>
                    ...
                    <input type='date' name='date'  class="login__input"required>
				
				<button class="button login__submit" type='submit' name='submit' value='Schedule trip '>
					<span class="button__text">Log In Now</span>
					<i class="button__icon fas fa-chevron-right"></i>
				</button>				
			</form>
			<div class="social-login">
				<h3>Add Shedule Trip</h3>
