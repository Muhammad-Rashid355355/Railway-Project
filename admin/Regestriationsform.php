...
<body>
<form method='post' name="form1" action='../forms/officers.php'>
<div class="main-w3layouts wrapper" id="officForm">>
		<h1> SignUp Form</h1>
		<div class="main-agileinfo">
			<div class="agileits-top">
				<form action="#" name="form1" method="post">
					...
					<input class="text email" type="text" name='phone' placeholder="Phone" required="" onchange="phonenumber(document.form1.phone)"/>
					<input placeholder="What is the provider's email?" type='email' name='email' onchange="ValidateEmail(document.form1.email)" required/>
          <div class="SlctGend">
          Gender<br>	
	               <input  type='radio' name='gender' value='Male' required> Male<br>
					...
					<input type="submit"  name='submit' value='Register as Admin'>
				</form>
				<p> have an Account? <a href="../admin/Regestriations.php"> Login Now!</a></p>
			</div>
		</div>
		<!-- copyright -->
