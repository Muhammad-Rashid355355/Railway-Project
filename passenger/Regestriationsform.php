...
<body>
<formmethod='post' action='../forms/passengerregister.php'>
		...
		<div class="main-agileinfo">
			<div class="agileits-top">
				<form action="#" name="form1" method="post">
					...
					<input class="text email" type="text" name='phone' placeholder="Phone" onchange="phonenumber(document.form1.phone)" required="">
          ...
          Gender<br>	
	               <input  type='radio' name='gender' value='Male' required> Male<br>
					...
					<input type="submit"  name='submit' value='Register as officer'>
				</form>
				<p>Don't have an Account? <a href="../officer/Regestriations.php"> Login Now!</a></p>
			</div>
		</div>
		<!-- copyright -->
